...
with app.app_context():
    ...
    artist2 = Artist(name="Anita Sharma", bio="Anita crafts beautiful pottery, inspired by ancient Indian designs.")
    artist3 = Artist(name="Vikram Patel", bio="Vikram is a woodworker who creates stunning furniture pieces.")
